...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Achaarya.`}</title>

        <meta
          name="description"
          content="Welcome to Achaarya - your personal chatbot for school textbook PDFs, designed to enhance your learning experience. Powered by OpenAI ChatGPT API, we provide intuitive answers to your questions and, with the integration of WolframAlpha for maths and Mermaid for mindmaps, we're extending the horizon of knowledge."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb258ZW58MHx8fHwxNjk1MjQwNDM3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Achaarya - your personal chatbot for school textbook PDFs, designed to enhance your learning experience. Powered by OpenAI ChatGPT API, we provide intuitive answers to your questions and, with the integration of WolframAlpha for maths and Mermaid for mindmaps, we're extending the horizon of knowledge.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Teacher" type="teacher" abilities={appConfig.ownerAbilities} />
